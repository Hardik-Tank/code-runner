...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},65779,a=>{"use strict";var b=a.i(87924),c=a.i(19957),d=a.i(29662);a.i(11241);var e=a.i(96373),f=a.i(72131),g=a.i(77926);function h({children:a,client:b,useAuth:c}){var d;let e=(d=c,(0,f.useMemo)(()=>function(){let{isLoaded:a,isSignedIn:b,getToken:c,orgId:e,orgRole:g}=d(),h=(0,f.useCallback)(async({forceRefreshToken:a})=>{try{return await c({template:"convex",skipCache:a})}catch{return null}},[e,g]);return(0,f.useMemo)(()=>({isLoading:!a,isAuthenticated:b??!1,fetchAccessToken:h}),[a,b,h])},[d]));return f.default.createElement(g.ConvexProviderWithAuth,{client:b,useAuth:e},a)}let i=new e.ConvexReactClient("https://doting-dachshund-25.convex.cloud");function j({children:a}){return(0,b.jsx)(c.ClerkProvider,{publishableKey:"pk_test_ZW5hYmxpbmctYWxiYWNvcmUtNzQuY2xlcmsuYWNjb3VudHMuZGV2JA",children:(0,b.jsx)(h,{client:i,useAuth:d.useAuth,children:a})})}a.s(["default",()=>j],65779)},53305,a=>{"use strict";var b=a.i(72131),c=a.i(98003);a.i(11241);var d=a.i(96373),e=a.i(1322);function f(){let{user:a}=(0,c.useUser)(),f=(0,d.useMutation)(e.api.users.syncUser);return(0,b.useEffect)(()=>{a&&f({userId:a.id,email:a.emailAddresses[0].emailAddress,name:a.fullName||"User"})},[a]),null}a.s(["default",()=>f])},11080,a=>{a.v(b=>Promise.all(["server/chunks/ssr/node_modules_@clerk_nextjs_dist_esm_app-router_b90809ae._.js"].map(b=>a.l(b))).then(()=>b(88985)))}];

//# sourceMappingURL=_8247a4b3._.js.map