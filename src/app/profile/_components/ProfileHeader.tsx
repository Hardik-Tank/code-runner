...
function ProfileHeader({ userStats, userData, user }: ProfileHeaderProps) {
  ...
  return (
    <div className="relative mb-8 bg-linear-to-br from-[#12121a] to-[#1a1a2e] rounded-2xl p-8 border border-gray-800/50 overflow-hidden">
      <div className="absolute inset-0 bg-grid-white/[0.02] bg-size-[32px]" />

      <div className="relative flex items-center gap-8">
        {/* Avatar */}
        <div className="relative group shrink-0">
          <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-purple-600 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />

          {/* Fixed circle container so image NEVER becomes full tab */}
          <div className="relative z-10 w-32 h-32 rounded-full overflow-hidden border-4 border-gray-800/50 group-hover:scale-105 transition-transform">
            <img
              src={user.imageUrl}
              alt="Profile"
          ...
          {userData.isPro && (
            <div className="absolute -top-2 -right-2 bg-linear-to-r from-purple-500 to-purple-600 p-2 rounded-full z-20 shadow-lg animate-pulse">
